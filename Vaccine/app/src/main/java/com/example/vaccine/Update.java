        ...
        btnsave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dbl.execSQL("update history set name = '" +
                        input_name.getText().toString() +"', emailf =  '" +
                        input_email.getText().toString() + "', vaccine = '" +
                        input_vaccine.getText().toString() + "', location = '" +
                        input_location.getText().toString() + "' where name = '" +
